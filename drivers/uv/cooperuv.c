...
* Modified for Galaxy Ace by <skynet28@xda developers>
...
#define OFS_KALLSYMS_LOOKUP_NAME 0xC00CFC1C // kallsyms_lookup_name
...
standard_clocks = (void*) kallsyms_lookup_name_dx("pll0_960_pll1_245_pll2_800");
