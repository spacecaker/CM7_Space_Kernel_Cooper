...
@ options passed:  -nostdinc -I /home/robin/Kernel/kernel/arch/arm/include
@ -I include -I arch/arm/mach-msm/include
@ -iprefix /home/robin/CodeSourcery/CodeSourcery/bin/../lib/gcc/arm-none-eabi/4.6.1/
@ -isysroot /home/robin/CodeSourcery/CodeSourcery/bin/../arm-none-eabi
...
@ -isystem /home/robin/CodeSourcery/CodeSourcery/bin/../lib/gcc/arm-none-eabi/4.6.1/include
...
@ -mfpu=vfp -mtune=arm1136jf-s -auxbase-strip kernel/bounds.s -O3 -Wall
